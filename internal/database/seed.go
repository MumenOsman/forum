...
func seedComments(db *sql.DB) {
	comments := []struct {
		...
		{id: "c-1", postID: "post-elara-1", userID: "user-marcus", content: "I quite enjoyed the 'interlude' chapters at the Waystone Inn. The framing of an old legend hiding as a simple tavern-keeper is a classic historical device, handled with great dignity here.", likes: 3, createdAt: "2026-03-01 11:15:00"},
		{id: "c-2", postID: "post-elara-1", userID: "user-sarah", content: "That frame-narrative is such a masterclass in tension! We know exactly where he ends up, but the 'how' is what keeps the pages turning. Rothfuss is brilliant at withholding just enough.", likes: 5, createdAt: "2026-03-01 12:30:00"},
		
		// Comments on Post 2 (Dune)
		{id: "c-3", postID: "post-elara-2", userID: "user-julian", content: "I agree, the prose was a slog, but the lessons on long-term ecological planning and the danger of charismatic leaders are still incredibly relevant for anyone in leadership today.", likes: 4, createdAt: "2026-03-10 14:45:00"},
		
		// Comments on Post 3 (Magic Systems)
		{id: "c-4", postID: "post-elara-3", userID: "user-sarah", content: "Setting costs is something I've been struggling with. Thanks for the tip—I think making my protagonist lose a literal memory for each spell would add that stakes I was missing!", likes: 8, createdAt: "2026-03-18 13:50:00"},
		{id: "c-5", postID: "post-elara-3", userID: "user-chloe", content: "This is so helpful! Can I use a 'cost' like this in a paranormal romance, or is that too grim? I want the love to be the focus, but the magic should feel real too! ✨", likes: 2, createdAt: "2026-03-18 15:10:00"},
		
		// Comments on Post 5 (Wolf Hall)
		{id: "c-6", postID: "post-marcus-1", userID: "user-elara", content: "The way Cromwell manipulates the court feels so much like the political intrigue in some of my favorite high-fantasy series. Do you think George R.R. Martin was inspired by the Tudors?", likes: 6, createdAt: "2026-03-03 16:30:00"},
		
		// Comments on Post 6 (Hamilton)
		{id: "c-7", postID: "post-marcus-2", userID: "user-julian", content: "Hamilton's work ethic was truly insane. Chernow makes a great point—he was a master of high-output management before the term even existed. It’s basically a productivity manual.", likes: 4, createdAt: "2026-03-12 18:15:00"},
		
		// Comments on Post 7 (Historical Accuracy)
		{id: "c-8", postID: "post-marcus-3", userID: "user-sarah", content: "I'm definitely taking notes on the 'In-Between' spaces strategy. It feels much less intimidating than trying to rewrite literal history!", likes: 5, createdAt: "2026-03-19 15:40:00"},
		
		// Comments on Post 8 (Steve Jobs)
		{id: "c-9", postID: "post-marcus-4", userID: "user-julian", content: "While I don't condone the behavior, it's hard to argue with the results. Jobs understood the intersection of technology and the liberal arts better than anyone in history.", likes: 7, createdAt: "2026-03-22 17:20:00"},
		{id: "c-10", postID: "post-marcus-4", userID: "user-chloe", content: "Honestly, I couldn't even finish the book because he was just too mean to everyone! 😭 I don't care how cool the iPhone is, you have to be a nice person!", likes: 12, createdAt: "2026-03-22 18:45:00"},
		
		// Comments on Post 9 (Pride and Prejudice)
		{id: "c-11", postID: "post-chloe-1", userID: "user-marcus", content: "The historical societal constraints were actually quite realistic for the Regency era. The desperation for a 'good match' was a matter of survival, not just romance.", likes: 9, createdAt: "2026-03-05 11:20:00"},
		{id: "c-12", postID: "post-chloe-1", userID: "user-sarah", content: "As a writer, I'm always analyzing how Austen manages the 'prejudice' shift. It's so subtle! You don't realize Lizzy is changing her mind until she already has.", likes: 11, createdAt: "2026-03-05 13:40:00"},
		
		// Comments on Post 10 (Gone Girl)
		{id: "c-13", postID: "post-chloe-2", userID: "user-sarah", content: "The structural shift in the middle is absolutely legendary. I still remember the physical chill I got when I turned that page. Truly a masterclass in tension.", likes: 14, createdAt: "2026-03-14 23:30:00"},
		{id: "c-14", postID: "post-chloe-2", userID: "user-elara", content: "It's brilliantly written, but honestly? It was a bit too dark for my taste. I prefer my villains to have a bit more... magic, perhaps? Or at least some honor.", likes: 3, createdAt: "2026-03-15 09:15:00"},
		
		// Comments on Post 11 (Slow Burn)
		{id: "c-15", postID: "post-chloe-3", userID: "user-sarah", content: "How do you keep the middle from sagging when nothing 'big' is happening yet? I always feel like I'm just treading water until the confession!", likes: 6, createdAt: "2026-03-20 22:10:00"},
		
		// Comments on Post 13 (Thinking Fast and Slow)
		{id: "c-16", postID: "post-julian-1", userID: "user-marcus", content: "I can see so many historical blunders that were clearly System 1 errors. Napoleon's march on Moscow comes to mind immediately. Excessive overconfidence!", likes: 5, createdAt: "2026-03-07 19:20:00"},
		
		// Comments on Post 14 (50 Books a Year)
		{id: "c-17", postID: "post-julian-2", userID: "user-elara", content: "I actually disagree with the DNF rule! Sometimes a book is a struggle for a reason, and the reward is in the completion. I've never abandoned a book and I never will!", likes: 4, createdAt: "2026-03-16 10:45:00"},
		{id: "c-18", postID: "post-julian-2", userID: "user-chloe", content: "I love the audiobook tip! I listen to all my thrillers while I'm doing my skincare routine and it's the best part of my day! 🌸✨", likes: 8, createdAt: "2026-03-16 12:30:00"},
		{id: "c-19", postID: "post-julian-2", userID: "user-sarah", content: "I'm officially adopting the DNF rule starting today. I have three books on my desk that I've been avoiding for months—time to let them go!", likes: 10, createdAt: "2026-03-16 14:15:00"},
		
		// Comments on Post 15 (Atomic Habits)
		{id: "c-20", postID: "post-julian-3", userID: "user-marcus", content: "I actually disagree that it's bloated. From an educational standpoint, the repetition is vital for internalizing the laws of behavior. You have to hear it multiple times for it to stick.", likes: 6, createdAt: "2026-03-21 13:40:00"},
		
		// Comments on Post 16 (Top 5 Books)
		{id: "c-21", postID: "post-julian-4", userID: "user-chloe", content: "Julian, please!! This list is too serious! 😭 I demand that you read at least one fiction book this year and report back here!", likes: 15, createdAt: "2026-03-23 15:50:00"},
		
		// Comments on Post 17 (Outlining vs Pantsing)
		{id: "c-22", postID: "post-sarah-1", userID: "user-elara", content: "For me, the worldbuilding alone requires heavy outlining. If I don't know the geography and the magic rules beforehand, the story just collapses into a mess.", likes: 7, createdAt: "2026-03-08 13:20:00"},
		{id: "c-23", postID: "post-sarah-1", userID: "user-chloe", content: "I'm a total pantser! Romance needs that organic chemistry, and I feel like if I plan it too much, it just feels fake. Let the hearts decide! 💖", likes: 5, createdAt: "2026-03-08 15:45:00"},
		
		// Comments on Post 18 (The Secret History)
		{id: "c-24", postID: "post-sarah-2", userID: "user-marcus", content: "I quite enjoyed the classical Greek references. Tartt clearly did her homework on the Bacchae—it adds a layer of ancient tragedy to the modern setting.", likes: 8, createdAt: "2026-03-17 21:30:00"},
		
		// Comments on Post 19 (Red Herrings)
		{id: "c-25", postID: "post-sarah-3", userID: "user-chloe", content: "Yes!! This is exactly why I love thrillers so much! That moment when you realize you were looking at the wrong thing the whole time is the best! 🕵️‍♀️💖", likes: 12, createdAt: "2026-03-21 19:40:00"},
		{id: "c-26", postID: "post-sarah-3", userID: "user-elara", content: "It's quite similar to foreshadowing in fantasy. If you introduce a sword on page 10, it better be the one that kills the dragon on page 50０. Great tips!", likes: 6, createdAt: "2026-03-21 21:15:00"},
		
		// Comments on Post 20 (Tomorrow x3)
		{id: "c-27", postID: "post-sarah-4", userID: "user-julian", content: "I appreciated the realistic depiction of startup culture and the creative partnership dynamics. It's rare to see the exhaustion of building something new portrayed so accurately.", likes: 9, createdAt: "2026-03-23 21:40:00"},
	}
